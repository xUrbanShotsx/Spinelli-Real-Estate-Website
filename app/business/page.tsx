...
export const metadata: Metadata = {
  title: "Business Sales | Spinelli Real Estate",
  description:
    "Buy or sell a business in the Illawarra with Spinelli Real Estate. Confidential, professional business broking services.",
};

export default function BusinessPage() {
  return (
    <>
      <BusinessListings properties={businessListings} />

      {/* ── CTA ── */}
      <section className="relative overflow-hidden" style={{ backgroundColor: "#0D3348" }}>
        <img
          src="https://images.unsplash.com/photo-1521791136064-7986c2920216?w=1400&h=500&fit=crop&q=60"
          alt=""
          aria-hidden="true"
        ...
        <div className="relative max-w-7xl mx-auto px-6 sm:px-12 lg:px-20 py-24">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="label-tag-light">Confidential Enquiry</span>
              <h2
                style={{
              ...
              >
                Thinking of Selling<br />Your Business?
              </h2>
            </div>
            <div>
              <p className="mb-8" style={{ fontFamily: "var(--font-sans)", fontSize: "14px", color: "rgba(255,255,255,0.6)", lineHeight: 1.75, maxWidth: "42ch" }}>
                Contact us for a confidential, obligation-free discussion about your business value and the best path to sale. Everything stays strictly private.
              </p>
