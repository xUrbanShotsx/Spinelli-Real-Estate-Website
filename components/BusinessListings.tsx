...
const INDUSTRIES = ["All Industries", "Hospitality", "Retail", "Trade & Services", "Health & Beauty", "Franchise", "Professional Services"];
...
export default function BusinessListings({ properties }: { properties: Property[] }) {
  ...
  const filtered = properties.filter((p) => {
    ...
    return match.includes(industry.toLowerCase().split(" ")[0].toLowerCase());
  });

  const hasFilters = industry !== "All Industries";
  const clearAll = () => setIndustry("All Industries");
      ...
      <div style={{ paddingLeft: "40px", paddingRight: "40px" }}>
        ...
        {filtered.length > 0 ? (
          ...
          <div className="py-20 text-center">
            <p style={{ fontFamily: "var(--font-display)", fontSize: "1.5rem", color: "#000000", fontWeight: 300, letterSpacing: "-0.02em", marginBottom: "10px" }}>No listings match your search</p>
